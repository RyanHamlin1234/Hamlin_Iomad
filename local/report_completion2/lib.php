...
class comprep2{
    ...
    public static function courseselectlist($companyid = 0) {
        ...
        // Create "empty" array.
        $courseselect = array(0 => get_string('select', 'local_report_completion2'));
    ...
    public static function participantsselectlist($courseid, $companyid ) {
        ...
        // Empty list.-
        $participantselect = array(0 => get_string('select', 'local_report_completion2'));
    ...
    public static function getcompanyusers( $companyid ) {
        ...
        foreach ($dataids as $dataid) {
            ...
            if (!$user = $DB->get_record( 'user', array('id' => $userid))) {
                print_error( 'userrecordnotfound', 'local_report_completion2' );
            }
            $users[] = $user;
        }
