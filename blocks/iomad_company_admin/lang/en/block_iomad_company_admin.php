...
$string['licensedetails'] = '{$a->name} - ({$a->used} used out of {$a->allocation})';
...
$string['shared_help'] = '<ul><li><b>No</b> - Course is not shared</li><li><b>Open sharing</b> - Course is shared with <b>all</b> companies</li><li><b>Closed sharing</b> - Course shared with selected companies (see <i>Course management > Assign to company</i>)</li></ul>';
...
$string['user_courses_for'] = 'Courses for \'{$a}\'';
